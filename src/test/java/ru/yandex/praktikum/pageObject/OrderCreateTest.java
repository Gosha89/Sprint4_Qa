...
public class OrderCreateTest {
    ...
    public static Object[][] getParameters() {
        return new Object[][]{
                {UP_BUTTON, "Иван", "Иванов", "ул Тестовая 1", 123, "79999999999", "29.06.2024", SIX_DAYS, GREY, "Заранее позвоните"},
                {UP_BUTTON, "Петр", "Петров", "ул Тестовая 2", 7, "79000000000", "29.06.2024", FIVE_DAYS, BLACK, "Заранее позвоните"},
                {UP_BUTTON, "Анна", "Рябова", "ул Тестовая 3", 10, "79555555555", "29.06.2024", ONE_DAY, BLACK, "Заранее позвоните"},
                {DOWN_BUTTON, "Иван", "Иванов", "ул Тестовая 1", 123, "79999999999", "29.06.2024", SIX_DAYS, GREY, "Заранее позвоните"},
                {DOWN_BUTTON, "Петр", "Петров", "ул Тестовая 2", 7, "79000000000", "29.06.2024", FIVE_DAYS, BLACK, "Заранее позвоните"},
                {DOWN_BUTTON, "Анна", "Рябова", "ул Тестовая 3", 10, "79555555555", "29.06.2024", ONE_DAY, BLACK, "Заранее позвоните"},
        };
    }
